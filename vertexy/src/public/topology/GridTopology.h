...
public:
	...
	inline int getNumVertices() const { return m_width * m_height * m_depth; }

	inline bool isValidVertex(int vertex) const { return vertex >= 0 && vertex < getNumVertices(); }
	...
	{
		int32_t x, y, z;
		indexToCoordinate(vertexIndex, x, y, z);
