...
namespace VertexyTests
{
	...
	public:
		...
		static int solveNeighbor(int times, int seed, bool printVerbose = true);
		...
		static int checkNeighbor(ConstraintSolver* solver, shared_ptr<TTopologyVertexData<VarID>> tileData, const shared_ptr<PrefabManager>& prefabManager);
